  ...
  return (
    <section className="py-24">
      <div className="container mx-auto max-w-5xl px-4">
        <Card className="transition-all duration-500 hover:-translate-y-1 hover:shadow-xl"> 
          <CardContent className="flex flex-col items-center px-8 py-16 text-center">
            ...
            <blockquote className="font-serif text-3xl leading-relaxed italic md:text-5xl">
