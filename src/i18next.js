    ...
    resources: {
      en: {
        translation: {
          ...
          restorePage: {
            welcome: 'Restore Access',
            subtitle: 'Enter your email to restore your account',
            email: 'Email',
            send: 'Send Request',
            sending: 'Sending...',
            success: 'Recovery request sent successfully',
            failed: 'Failed to send recovery request',
      ...
      ar: {
        translation: {
          ...
          restorePage: {
            welcome: 'استعادة الوصول',
            subtitle: 'أدخل بريدك الإلكتروني لاستعادة حسابك',
            email: 'البريد الإلكتروني',
            send: 'إرسال الطلب',
            sending: 'جارٍ الإرسال...',
            success: 'تم إرسال طلب الاستعادة بنجاح',
            failed: 'فشل إرسال طلب الاستعادة',
